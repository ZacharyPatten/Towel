...
namespace Towel
{
	...
	public struct ActionRuntime : IAction
	{
		...
		public static implicit operator ActionRuntime(Action @delegate) => new() { _delegate = @delegate, };
	}
	...
	public struct ActionRuntime<T1, T2> : IAction<T1, T2>
	{
		...
		/// <summary>Implicit caster from a delegate.</summary>
		public static implicit operator ActionRuntime<T1, T2>(Action<T1, T2> @delegate) => new() { _delegate = @delegate, };
	}
	...
	public struct ActionRuntime<T1, T2, T3> : IAction<T1, T2, T3>
	{
		...
		/// <summary>Implicit caster from a delegate.</summary>
		public static implicit operator ActionRuntime<T1, T2, T3>(Action<T1, T2, T3> @delegate) => new() { _delegate = @delegate, };
	}
	...
	public struct ActionRuntime<T1, T2, T3, T4> : IAction<T1, T2, T3, T4>
	{
		...
		/// <summary>Implicit caster from a delegate.</summary>
		public static implicit operator ActionRuntime<T1, T2, T3, T4>(Action<T1, T2, T3, T4> @delegate) => new() { _delegate = @delegate, };
	}
	...
	public struct ActionRuntime<T1, T2, T3, T4, T5> : IAction<T1, T2, T3, T4, T5>
	{
		...
		/// <summary>Implicit caster from a delegate.</summary>
		public static implicit operator ActionRuntime<T1, T2, T3, T4, T5>(Action<T1, T2, T3, T4, T5> @delegate) => new() { _delegate = @delegate, };
	}
	...
	public struct ActionRuntime<T1, T2, T3, T4, T5, T6> : IAction<T1, T2, T3, T4, T5, T6>
	{
		...
		/// <summary>Implicit caster from a delegate.</summary>
		public static implicit operator ActionRuntime<T1, T2, T3, T4, T5, T6>(Action<T1, T2, T3, T4, T5, T6> @delegate) => new() { _delegate = @delegate, };
	}
	...
	public struct ActionRuntime<T1, T2, T3, T4, T5, T6, T7> : IAction<T1, T2, T3, T4, T5, T6, T7>
	{
		...
		/// <summary>Implicit caster from a delegate.</summary>
		public static implicit operator ActionRuntime<T1, T2, T3, T4, T5, T6, T7>(Action<T1, T2, T3, T4, T5, T6, T7> @delegate) => new() { _delegate = @delegate, };
	}
	...
	public struct FuncRuntime<TResult> : IFunc<TResult>
	{
		...
		/// <summary>Implicit caster from a delegate.</summary>
		public static implicit operator FuncRuntime<TResult>(Func<TResult> @delegate) => new() { _delegate = @delegate, };
	}
	...
	public struct FuncRuntime<T1, TResult> : IFunc<T1, TResult>
	{
		...
		/// <summary>Implicit caster from a delegate.</summary>
		public static implicit operator FuncRuntime<T1, TResult>(Func<T1, TResult> @delegate) => new() { _delegate = @delegate, };
	}
	...
	public struct FuncRuntime<T1, T2, TResult> : IFunc<T1, T2, TResult>
	{
		...
		/// <summary>Implicit caster from a delegate.</summary>
		public static implicit operator FuncRuntime<T1, T2, TResult>(Func<T1, T2, TResult> @delegate) => new() { _delegate = @delegate, };
	}
	...
	public struct FuncRuntime<T1, T2, T3, TResult> : IFunc<T1, T2, T3, TResult>
	{
		...
		/// <summary>Implicit caster from a delegate.</summary>
		public static implicit operator FuncRuntime<T1, T2, T3, TResult>(Func<T1, T2, T3, TResult> @delegate) => new() { _delegate = @delegate, };
	}
	...
	public struct FuncRuntime<T1, T2, T3, T4, TResult> : IFunc<T1, T2, T3, T4, TResult>
	{
		...
		/// <summary>Implicit caster from a delegate.</summary>
		public static implicit operator FuncRuntime<T1, T2, T3, T4, TResult>(Func<T1, T2, T3, T4, TResult> @delegate) => new() { _delegate = @delegate, };
	}
	...
	public struct FuncRuntime<T1, T2, T3, T4, T5, TResult> : IFunc<T1, T2, T3, T4, T5, TResult>
	{
		...
		/// <summary>Implicit caster from a delegate.</summary>
		public static implicit operator FuncRuntime<T1, T2, T3, T4, T5, TResult>(Func<T1, T2, T3, T4, T5, TResult> @delegate) => new() { _delegate = @delegate, };
	}
	...
	public struct FuncRuntime<T1, T2, T3, T4, T5, T6, TResult> : IFunc<T1, T2, T3, T4, T5, T6, TResult>
	{
		...
		/// <summary>Implicit caster from a delegate.</summary>
		public static implicit operator FuncRuntime<T1, T2, T3, T4, T5, T6, TResult>(Func<T1, T2, T3, T4, T5, T6, TResult> @delegate) => new() { _delegate = @delegate, };
	}
	...
	public struct FuncRuntime<T1, T2, T3, T4, T5, T6, T7, TResult> : IFunc<T1, T2, T3, T4, T5, T6, T7, TResult>
	{
		...
		/// <summary>Implicit caster from a delegate.</summary>
		public static implicit operator FuncRuntime<T1, T2, T3, T4, T5, T6, T7, TResult>(Func<T1, T2, T3, T4, T5, T6, T7, TResult> @delegate) => new() { _delegate = @delegate, };
	}
}
