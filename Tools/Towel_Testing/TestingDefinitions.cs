...
namespace Towel_Testing
{
	...
	public class RefNumeric<T>
	{
		...
		public static RefNumeric<T> operator *(RefNumeric<T> a, RefNumeric<T> b) => new(Multiplication(a._value, b._value));
		public static RefNumeric<T> operator +(RefNumeric<T> a, RefNumeric<T> b) => new(Addition(a._value, b._value));
		public static RefNumeric<T> operator /(RefNumeric<T> a, RefNumeric<T> b) => new(Division(a._value, b._value));
		public static RefNumeric<T> operator -(RefNumeric<T> a, RefNumeric<T> b) => new(Subtraction(a._value, b._value));
		public static RefNumeric<T> operator %(RefNumeric<T> a, RefNumeric<T> b) => new(Remainder(a._value, b._value));
		public static implicit operator RefNumeric<T>(T a) => new(a);
		public static implicit operator T(RefNumeric<T> a) => a._value;
		public static implicit operator RefNumeric<T>(int a) => new(Convert<int, T>(a));
		...
		public static RefNumeric<T> operator -(RefNumeric<T> a) => new(Negation(a._value));
