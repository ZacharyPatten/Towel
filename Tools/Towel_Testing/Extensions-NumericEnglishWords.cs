...
namespace Towel_Testing
{
	...
	public partial class Extensions_Testing
	{
		internal (decimal Value, string Words)[] ExplicitTestCases =
		{
			...
			(     1.01m, "One And One Hundreths"),
			(     1.02m, "One And Two Hundreths"),
			(     2.01m, "Two And One Hundreths"),
			(    10.01m, "Ten And One Hundreths"),
			(    10.02m, "Ten And Two Hundreths"),
			(    20.01m, "Twenty And One Hundreths"),
			(    20.02m, "Twenty And Two Hundreths"),
