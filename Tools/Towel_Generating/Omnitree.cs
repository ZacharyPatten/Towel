...
$@"//------------------------------------------------------------------------------
//// <auto-generated>
////	This code was generated from ""{Meta.SourceFile()}"".
//// </auto-generated>
////------------------------------------------------------------------------------
...
namespace Towel_Generating.DataStructures
{{
	#region Notes
...
");
			for (int i = 1; i <= dimensions; i++)
			{
				...
				partials["A1, A2, A3..."] = string.Join(", ", ie.Select(n => $"A{n}"));
				partials["A1 axis1, A2 axis2, A3 axis3..."] = string.Join(", ", ie.Select(n => $"A{n} axis{n}"));
				partials["default(A1), default(A2), default(A3)..."] = string.Join(", ", ie.Select(n => $"default(A{n})"));
...
$@"				/// <typeparam name=""Axis{j}"">The generic type of the {j} dimension.</typeparam>");
				...
				file.AppendLine(
$@"		public struct Bounds<{__("A1, A2, A3...")}>
{{");
				for (int j = 2; j <= i; j++)
				{
					file.AppendLine(
...
$@"			/// <summary>Extends infinitely along each axis.</summary>
			public static Bounds<{__("A1, A2, A3...")}> None =>
				new Bounds<{__("A1, A2, A3...")}>(Bound<A1>.None, Bound<A1>.None");
				for (int j = 2; j <= i; j++)
				{
					file.AppendLine(
