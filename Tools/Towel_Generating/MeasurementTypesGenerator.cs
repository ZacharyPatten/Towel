...
namespace Towel_Generating
{
	public static class MeasurementTypesGenerator
	{
		public static string Run()
		{
			...
			var multiplicativeMeasurementTypes = new (string, string[], string[])[]
			{
				/* MeasureMent          Numeraters                        Denominators */
				("Acceleration",        Ɐ("Length"),                      Ɐ("Time", "Time")),
				("AngularAcceleration", Ɐ("Angle"),                       Ɐ("Time", "Time")),
				("AngularSpeed",        Ɐ("Angle"),                       Ɐ("Time")),
				("Area",                Ɐ("Length", "Length"),            none),
				("AreaDensity",         Ɐ("Mass"),                        Ɐ("Length", "Length")),
				("Density",             Ɐ("Mass"),                        Ɐ("Length", "Length", "Length")),
				("ElectricCharge",      Ɐ("ElectricCharge"),              none),
				("ElectricCurrent",     Ɐ("ElectricCharge"),              Ɐ("Time")),
				("Energy",              Ɐ("Mass", "Length", "Length"),    Ɐ("Time", "Time")),
				("Force",               Ɐ("Mass", "Length" ),             Ɐ("Time", "Time" )),
				("LinearDensity",       Ɐ("Mass"),                        Ɐ("Length")),
				("LinearMass",          Ɐ("Mass", "Length"),              none),
				("LinearMassFlow",      Ɐ("Mass", "Length"),              Ɐ("Time" )),
				("MassRate",            Ɐ("Mass"),                        Ɐ("Time")),
				("Power",               Ɐ("Mass", "Length", "Length"),    Ɐ("Time", "Time", "Time")),
				("Pressure",            Ɐ("Mass"),                        Ɐ("Length", "Time", "Time")),
				("Speed",               Ɐ("Length"),                      Ɐ("Time")),
				("Tempurature",         Ɐ("Tempurature"),                 none),
				("TimeArea",            Ɐ("Time", "Time"),                none),
				("Volume",              Ɐ("Length", "Length", "Length"),  none),
				("VolumeRate",          Ɐ("Length", "Length", "Length" ), Ɐ("Time")),
			};

			//("Torque", Ɐ("Mass", "Length", "Length" ), Ɐ("Time", "Time" )),
