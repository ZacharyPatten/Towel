...
namespace Towel.Measurements
{
    ...
    public static class Current
    {
        ...
        internal static T ConversionFactor<T>(Units a, Units b)
        {
            ...
            if (a == b)
            {
                throw new Exception("There is a bug in " + nameof(Towel) + ". (" + nameof(Current) + "." + nameof(ConversionFactor) + " attempted on like units)");
            }
            throw new NotImplementedException(nameof(Towel) + " is missing a conversion factor in " + nameof(Current) + " for " + a + " -> " + b + ".");
        }
    ...
    public struct Current<T>
    {
        ...
        internal T this[Current.Units units]
        {
            get
            {
                ...
                {
                    T factor = Current.ConversionFactor<T>(this._units, units);
