...
namespace Towel.Measurements
{
    ...
    public static class Power
    {
        ...
        internal static T ConversionFactor<T>(Units a, Units b)
        {
            ...
            if (a == b)
            {
                throw new Exception("There is a bug in " + nameof(Towel) + ". (" + nameof(Power) + "." + nameof(ConversionFactor) + " attempted on like units)");
            }
            throw new NotImplementedException(nameof(Towel) + " is missing a conversion factor in " + nameof(Power) + " for " + a + " -> " + b + ".");
        }
    ...
    public struct Power<T>
    {
        ...
        internal T this[Power.Units units]
        {
            get
            {
                ...
                {
                    T factor = Power.ConversionFactor<T>(this._units, units);
