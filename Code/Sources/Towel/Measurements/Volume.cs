...
namespace Towel.Measurements
{
    ...
    public static class Volumne
    {
        ...
        internal static T ConversionFactor<T>(Units a, Units b)
        {
            ...
            if (a == b)
            {
                throw new Exception("There is a bug in " + nameof(Towel) + ". (" + nameof(Volumne) + "." + nameof(ConversionFactor) + " attempted on like units)");
            }
            throw new NotImplementedException(nameof(Towel) + " is missing a conversion factor in " + nameof(Volumne) + " for " + a + " -> " + b + ".");
        }
    ...
    public struct Volumne<T>
    {
        ...
        internal T this[Volumne.Units units]
        {
            get
            {
                ...
                {
                    T factor = Volumne.ConversionFactor<T>(this._units, units);
        ...
        //    get
        //    {
        //        return this[Volumne.Units.XXXXX];
        //    }
        //}
        ...
        public override string ToString()
        {
            switch (this._units)
            {
                ...
                default: throw new NotImplementedException(nameof(Towel) + " is missing a to string conversion in " + nameof(Volumne<T>) + ".");
            }
        }
