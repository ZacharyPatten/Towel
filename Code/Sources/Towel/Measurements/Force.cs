...
namespace Towel.Measurements
{
    ...
    public static class Force
    {
        ...
        internal static T ConversionFactor<T>(Units a, Units b)
        {
            ...
            if (a == b)
            {
                throw new Exception("There is a bug in " + nameof(Towel) + ". (" + nameof(Force) + "." + nameof(ConversionFactor) + " attempted on like units)");
            }
            throw new NotImplementedException(nameof(Towel) + " is missing a conversion factor in " + nameof(Force) + " for " + a + " -> " + b + ".");
        }
    ...
    public struct Force<T>
    {
        ...
        internal T this[Force.Units units]
        {
            get
            {
                ...
                {
                    T factor = Force.ConversionFactor<T>(this._units, units);
        ...
        public override string ToString()
        {
            switch (this._units)
            {
                ...
                default: throw new NotImplementedException(nameof(Towel) + " is missing a to string conversion in " + nameof(Force<T>) + ".");
            }
        }
