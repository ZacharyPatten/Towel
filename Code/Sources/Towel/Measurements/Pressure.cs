...
namespace Towel.Measurements
{
    ...
    public static class Pressure
    {
        ...
        internal static T ConversionFactor<T>(Units a, Units b)
        {
            ...
            if (a == b)
            {
                throw new Exception("There is a bug in " + nameof(Towel) + ". (" + nameof(Pressure) + "." + nameof(ConversionFactor) + " attempted on like units)");
            }
            throw new NotImplementedException(nameof(Towel) + " is missing a conversion factor in " + nameof(Pressure) + " for " + a + " -> " + b + ".");
        }
    ...
    public struct Pressure<T>
    {
        ...
        internal T this[Pressure.Units units]
        {
            get
            {
                ...
                {
                    T factor = Pressure.ConversionFactor<T>(this._units, units);
        ...
        //    get
        //    {
        //        return this[Pressure.Units.XXXXX];
        //    }
        //}
        ...
        public override string ToString()
        {
            switch (this._units)
            {
                ...
                default: throw new NotImplementedException(nameof(Towel) + " is missing a to string conversion in " + nameof(Pressure<T>) + ".");
            }
        }
