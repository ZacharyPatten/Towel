...
namespace Towel.Measurements
{
    ...
    public static class Density
    {
        ...
        internal static T ConversionFactor<T>(Units a, Units b)
        {
            ...
            if (a == b)
            {
                throw new Exception("There is a bug in " + nameof(Towel) + ". (" + nameof(Density) + "." + nameof(ConversionFactor) + " attempted on like units)");
            }
            throw new NotImplementedException(nameof(Towel) + " is missing a conversion factor in " + nameof(Density) + " for " + a + " -> " + b + ".");
        }
    ...
    public struct Desnity<T>
    {
        ...
        internal T this[Density.Units units]
        {
            get
            {
                ...
                {
                    T factor = Density.ConversionFactor<T>(this._units, units);
